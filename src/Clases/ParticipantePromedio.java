...
public class ParticipantePromedio {
	...
	double experienciaPromedio;
	
	public ParticipantePromedio(String dni_participante, String nombre_participante, String apellido_participante,
			...
			String id_funcion, String id_tipo_participante, double experienciaPromedio) {
		super();
	...
	public ParticipantePromedio(ParticipanteOut participanteOut, double experienciaPromedio) {
		super();
	...
	public double getExperienciaPromedio() {
		return experienciaPromedio;
	}

	public void setExperienciaPromedio(double experienciaPromedio) {
		this.experienciaPromedio = experienciaPromedio;
	}

	@Override
	public String toString() {
		return "ParticipantePromedio [dni_participante=" + dni_participante + ", nombre_participante="
				...
				+ ", experienciaPromedio=" + experienciaPromedio + "]";
	}
