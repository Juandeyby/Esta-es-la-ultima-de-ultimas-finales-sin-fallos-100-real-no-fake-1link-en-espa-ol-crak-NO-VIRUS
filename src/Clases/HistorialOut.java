...
public class HistorialOut {
	...
	String id_tipo_proceso;
	String id_fase_proceso;
	int anio_proceso;
	String id_cargo_proceso;
	int experiencia_historial_proceso;
	String observacion_historial_proceso;
	
	public HistorialOut(String dni_participante, String id_tipo_proceso, String id_fase_proceso, int anio_proceso,
			String id_cargo_proceso, int experiencia_historial_proceso, String observacion_historial_proceso) {
		super();
	...
	public String getId_tipo_proceso() {
		return id_tipo_proceso;
	}

	public void setId_tipo_proceso(String id_tipo_proceso) {
		this.id_tipo_proceso = id_tipo_proceso;
	}

	public String getId_fase_proceso() {
		return id_fase_proceso;
	}

	public void setId_fase_proceso(String id_fase_proceso) {
		this.id_fase_proceso = id_fase_proceso;
	}
	...
	public String getId_cargo_proceso() {
		return id_cargo_proceso;
	}

	public void setId_cargo_proceso(String id_cargo_proceso) {
		this.id_cargo_proceso = id_cargo_proceso;
	}
