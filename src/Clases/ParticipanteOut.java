...
public class ParticipanteOut {
	...
	public ParticipanteOut(String dni_participante, String nombre_participante, String apellido_participante,
			...
			String id_funcion, String id_tipo_participante) {
		super();
	...
	public String toString() {
		return "ParticipanteOut [dni_participante=" + dni_participante + ", nombre_participante=" + nombre_participante
