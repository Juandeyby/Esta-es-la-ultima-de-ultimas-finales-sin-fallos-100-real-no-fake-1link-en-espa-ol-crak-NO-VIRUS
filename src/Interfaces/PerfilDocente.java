...
public class PerfilDocente {
	...
	public void initialize(ParticipanteOut participante) {
        ...
        lblCorreoInstitucional.setBounds(110, 221, 114, 14);
        ...
        lblEspecialidad.setBounds(110, 296, 85, 14);
        panel.add(lblEspecialidad);
        
        JLabel lblDepartamento = new JLabel("Departamento");
        lblDepartamento.setBounds(110, 319, 102, 14);
        ...
        JLabel label_2 = new JLabel(participante.getTelefono_participante());
        label_2.setBounds(234, 88, 181, 14);
        panel.add(label_2);
        
        JLabel label_3 = new JLabel(participante.getApellido_participante());
        ...
        label_10.setBounds(234, 296, 181, 14);
        panel.add(label_10);
        
        JLabel label_11 = new JLabel("AREQUIPA");
        label_11.setBounds(234, 319, 181, 14);
        panel.add(label_11);
