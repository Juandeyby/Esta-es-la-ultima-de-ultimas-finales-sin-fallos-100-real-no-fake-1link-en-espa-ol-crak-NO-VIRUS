...
public class SeleccionControladores {

	public JFrame frame;
	DefaultTableModel model;
	JTable table11;

	public SeleccionControladores (List<ParticipanteBuscar> participantesBuscar, ArrayList<Object> capacidad) {
		frame = new JFrame();
		...
		Button31.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BuscarControladores buscarControladores = new BuscarControladores(participantesBuscar, capacidad);
				buscarControladores.frame.setVisible(true);
				Main.centralizar(buscarControladores.frame);
				frame.dispose();
			}
		});
//		Button31.setEnabled(false);
		...
		Button32.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SeleccionControladores seleccionControladores = new SeleccionControladores(participantesBuscar, capacidad);
		...
		Button33.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SeleccionControladores seleccionEspecificaFormuladores = new SeleccionControladores(participantesBuscar, capacidad);
		...
		btnRegresar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(i == 0){
					Conexion conn = new Conexion();
					conn.insertarExportar(3, participantesBuscar);
