...
public class SeleccionVerificador {

	public JFrame frame;
	DefaultTableModel model;
	JTable table11;

	public SeleccionVerificador (List<ParticipanteBuscar> participantesBuscar, ArrayList<Object> capacidad) {
		frame = new JFrame();
		...
		Button31.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BuscarVerificador buscarVerificador = new BuscarVerificador(participantesBuscar, capacidad);
				buscarVerificador.frame.setVisible(true);
				Main.centralizar(buscarVerificador.frame);
				frame.dispose();
			}
		});
//		Button31.setEnabled(false);
		...
		Button32.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SeleccionVerificador seleccionControladores = new SeleccionVerificador(participantesBuscar, capacidad);
		...
		Button33.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SeleccionVerificador seleccionEspecificaFormuladores = new SeleccionVerificador(participantesBuscar, capacidad);
		...
		btnRegresar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(i == 0){
					Conexion conn = new Conexion();
					conn.insertarExportar(7, participantesBuscar);
