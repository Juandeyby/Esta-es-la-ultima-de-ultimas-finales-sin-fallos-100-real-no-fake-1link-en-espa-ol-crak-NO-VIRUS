...
public class BuscarVerificador {
	...
	public BuscarVerificador (List<ParticipanteBuscar> participantesBuscar, ArrayList<Object> capacidad) {
		frame = new JFrame();
		...
		Action agregar = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        if (Integer.parseInt(capacidad.get(0).toString()) - seleccionados == 0) {
