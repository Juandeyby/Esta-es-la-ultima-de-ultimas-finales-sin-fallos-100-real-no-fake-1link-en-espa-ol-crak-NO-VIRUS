...
public class SeleccionConserje {

	public JFrame frame;
	DefaultTableModel model;
	JTable table11;

	public SeleccionConserje (List<ParticipanteBuscar> participantesBuscar, ArrayList<Object> capacidad) {
		frame = new JFrame();
		...
		Button31.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BuscarConserje buscarConserje = new BuscarConserje(participantesBuscar, capacidad);
				buscarConserje.frame.setVisible(true);
				Main.centralizar(buscarConserje.frame);
				frame.dispose();
			}
		});
//		Button31.setEnabled(false);
		...
		Button32.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SeleccionConserje seleccionControladores = new SeleccionConserje(participantesBuscar, capacidad);
		...
		Button33.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SeleccionConserje seleccionEspecificaFormuladores = new SeleccionConserje(participantesBuscar, capacidad);
		...
		btnRegresar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(i == 0){
					Conexion conn = new Conexion();
					conn.insertarExportar(5, participantesBuscar);
